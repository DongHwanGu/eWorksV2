...
class HrOvertimeWorkDetail extends Component {
    state = {
        weeklyTimeTotal: '',
        hrOvertimeWorkDto: {
            otId: 0
    ...
    saveResponseOvertimeWork(e) {
        ...
        var gParam = {
            ...
            statusCd: e.target.id === 'btnApproval' ? '10' : '99',
        ...
        axios.post(this.props.storeState.serviceUrl + "/HrOvertimeWorkService/SaveResponseOvertimeWork",
            gParamGroup)
            .then(r => {
                var data = r.data;
                        ...
                        <Form.Row>
                            <div className="col-md-12 text-right">
                                <Button variant="success" id="btnApproval" 
                                    style={{ display: this.state.hrOvertimeWorkDto.statusCd === '09' ? 'inline' : 'none' }}
                                    onClick={this.saveResponseOvertimeWork.bind(this)} >Approval</Button>{' '}
                                <Button variant="danger" id="btnReject" 
                                    style={{ display: this.state.hrOvertimeWorkDto.statusCd === '05' || this.state.hrOvertimeWorkDto.statusCd === '09' ? 'inline' : 'none' }}
                                    onClick={this.saveResponseOvertimeWork.bind(this)} >Reject</Button>
                            </div>
                        </Form.Row>
                    </Form>
                </Card.Header>
                <Card.Body>
                    <Form>
                        <Form.Row>
                            ...
                            {
                                this.state.hrOvertimeWorkDto.statusCd !== '05' 
                                    && this.state.hrOvertimeWorkDto.statusCd !== '09' 
                                    && this.state.hrOvertimeWorkDto.statusCd !== '10' 
                                    && this.state.hrOvertimeWorkDto.statusCd !== '99'
