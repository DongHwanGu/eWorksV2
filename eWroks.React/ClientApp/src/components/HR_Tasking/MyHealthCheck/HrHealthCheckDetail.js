...
class HrHealthCheckDetail extends Component {
    state = {
        hrHealthCheckDto: {
            healthId: 0
            , registerDt: new Date()
                                ...
                                <Table bordered>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{this.state.hrHealthCheckDto.regIdNm}</td>
                                        </tr>
                                        <tr>
                                            <th style={{ backgroundColor: '#e9ecef' }}>Department</th>
                                            <td>{this.state.hrHealthCheckDto.deptFullNm}</td>
                                        </tr>
                                        <tr>
                                            <th style={{ backgroundColor: '#e9ecef' }}>Position Kr</th>
                                            <td>{this.state.hrHealthCheckDto.dutyCdKorNm}</td>
                                        </tr>
                                        <tr>
