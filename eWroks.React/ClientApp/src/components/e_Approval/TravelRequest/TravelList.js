...
class TravelList extends Component {
    getDetailPage(data) {
        return (
            <TravelDetail id={data} saveCallback={this.saveCallback.bind(this)} onClickNew={this.onClickNew.bind(this)} />
        )
    }
    /*==========================================================*/
    /* State    */
    ...
    getTravelList() {
        ...
        axios.get(this.props.storeState.serviceUrl + "/FiTravelService/GetTravelList", {
            params: {
                                ...
                                <Form>
                                    ...
                                    <Form.Row>
                                        <div className="col-md-12 text-right">
                                            ...
                                            <Button variant="primary" onClick={this.getTravelList.bind(this)}>Search</Button>
                                        </div>
                                    </Form.Row>
                                </Form>
                            </Card.Header>
