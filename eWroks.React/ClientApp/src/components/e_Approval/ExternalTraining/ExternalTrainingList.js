...
import ExternalTrainingDetail from './ExternalTrainingDetail';


import GDHSelectOption from '../../common/controls/GDHSelectOption';
import GDHDatepicker from '../../common/controls/GDHDatepicker';

class ExternalTrainingList extends Component {
    getDetailPage(data) {
        return (
            <ExternalTrainingDetail id={data} 
                saveCallback={this.saveCallback.bind(this)} onClickNew={this.onClickNew.bind(this)} />
        )
    }
    /*==========================================================*/
    /* State    */
        ...
        masterGrid: {
            columnDefs:
                [
                    ...
                    {
                        headerName: 'Receipt', field: 'receipt', minWidth: 200,
                        cellRendererFramework: (params) => {
                            var trainingId = params.data.trainingId;
                            var uploadGb = params.data.listFileNm === '' ? false : true;
                            return (
                                uploadGb
                                    ? <>
                                        <span style={{ fontWeight: 'bold' }}>
                                        ...
                                        <><>&nbsp;&nbsp;&nbsp;</>
                                            <a href={'#'} style={{ color: 'black', fontSize: 15 }} onClick={(e) => {
                                                e.preventDefault();
                                                this.onfileUploadClickDelete(trainingId)
                                            }}>ⓧ</a>
                                        </>
                                    </>
                                    : <Form.File
                                        ...
                                        custom
                                        multiple={false}
                                        onChange={this.onfileUploadClick.bind(this, trainingId)}
                                    />
                            )
                        }
                    },
                    {
                        headerName: 'Voucher', field: 'voucher', minWidth: 60,
                        cellRendererFramework: (params) => {
                            var trainingId = params.data.trainingId;
                            return (
    ...
    /*==========================================================*/
    componentDidMount() {
        this.getExternalTrainingList();
    }

    /*==========================================================*/
    /* 마스터 리스트 조회    */
    /*==========================================================*/
    getExternalTrainingList() {
        this.props.onIsLoadingTrue();
        axios.get(this.props.storeState.serviceUrl + "/HrExternalTrainingService/GetExternalTrainingList", {
            params: {
	...
	/* 파일 업로드    */
	/*==========================================================*/
    onfileUploadClick(trainingId, e) {
        ...
        axios.post(this.props.storeState.serviceUrl + "/CommonService/UploadFiels", frmFiles, {
            ...
            var data = r.data;
            // alert(trainingId + data[0].fileNm + data[0].fileUrl  )
            this.onfileUploadClickSave(trainingId, data[0].fileNm, data[0].fileUrl);
        }).catch(function (error) {
            alert(error);
        });
    }
    onfileUploadClickSave(trainingId, fileNm, fileUrl) {
        axios.post(this.props.storeState.serviceUrl + "/HrExternalTrainingService/OnfileUploadClickSave", {}, {
            params: {
                trainingId, fileNm, fileUrl
            }
        }).then(r => {
                var data = r.data;
    ...
    onfileUploadClickDelete(trainingId) {
        axios.post(this.props.storeState.serviceUrl + "/HrExternalTrainingService/OnfileUploadClickDelete", {}, {
            params: {
                trainingId
            }
        }).then(r => {
                                ...
                                <Form>
                                    ...
                                    <Form.Row>
                                        <div className="col-md-12 text-right">
                                            ...
                                            <Button variant="primary" onClick={this.getExternalTrainingList.bind(this)}>Search</Button>
                                        </div>
                                    </Form.Row>
                                </Form>
                            </Card.Header>
