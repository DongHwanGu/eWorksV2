...
class PurchaseApprovedDetail extends Component {
    state = {
        remark: '',
        purchaseId: 0,
        apprId: 0,
    ...
    /* 승인 리젝 저장    */
    /*==========================================================*/
    saveTaskingPurchaseApproval(e) {
        var btnId = e.target.id;

        axios.post(this.props.storeState.serviceUrl + "/FiPurchaseService/SaveTaskingPurchaseApproval", {}, {
            params: {
                    ...
                    <div className="col-md-12 text-right">
                        {
                            this.state.apprId > 0
                                ? <>
                                    <Button variant="success" id="btnApproval" onClick={this.saveTaskingPurchaseApproval.bind(this)}>Approval</Button>{' '}
                                    <Button variant="danger" id="btnReject" onClick={this.saveTaskingPurchaseApproval.bind(this)} >Reject</Button>
                                </>
                                : <></>
                        }
                        ...
                        <td colSpan={2} style={{ backgroundColor: '#ccc' }}>
                            <table style={{ width: '100%' }}>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            <th style={{ backgroundColor: '#e9ecef', height: 25 }}>{' '}</th>
                                            <td style={{ backgroundColor: '#fafafa', textAlign: 'right', fontWeight: 'bold' }}>
                                                {' '}
                                            </td>
                                        </tr>
                            ...
                            <table style={{ width: '100%' }}>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style={{ backgroundColor: '#fafafa' }}>
                                            {
                                                this.state.fiPurchaseFileDtos.fileUrl4 === ''
                                                    ? <></>
                                                    : <a href={this.state.fiPurchaseFileDtos.fileUrl4} target={"_blank"}>
                                                        {this.state.fiPurchaseFileDtos.fileNm4}
                                                    </a>
                                            }
                                        </td>
                                    </tr>
