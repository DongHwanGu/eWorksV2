...
class OvertimeWorkApprovedSetepOne extends Component {
    /*==========================================================*/
    /* State    */
    /*==========================================================*/
    state = {
        ...
        masterGrid: {
            columnDefs:
                [
                    ...
                    {
                        headerName: '1단계 요청시간', field: 'oneStepDateNm', minWidth: 500,
    ...
    /*==========================================================*/
    componentDidMount() {
        this.getTaskingOvertimeWorkOneList();
    }

    /*==========================================================*/
    /* One List    */
    /*==========================================================*/
    getTaskingOvertimeWorkOneList() {
        this.props.onIsLoadingTrue();
        axios.get(this.props.storeState.serviceUrl + "/HrOvertimeWorkService/GetTaskingOvertimeWorkOneList", {
            params: {
    ...
    saveTaskingOvertimeWork(obj) {
        axios.post(this.props.storeState.serviceUrl + "/HrOvertimeWorkService/SaveTaskingOvertimeWork", {}, {
            params: {
                otId: obj.otId,
                apprId: obj.apprId,
                remark: obj.remark,
                    ...
                    <Form>
                        <Form.Row>
                            <div className="col-md-12 text-right">
                                ...
                                <Button variant="primary" onClick={this.getTaskingOvertimeWorkOneList.bind(this)} >Search</Button>
                            </div>
                        </Form.Row>
                    </Form>
                </Card.Header>
