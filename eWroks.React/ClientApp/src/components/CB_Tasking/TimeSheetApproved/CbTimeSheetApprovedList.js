...
import CbTimeSheetDepartment from './CbTimeSheetDepartment';
import CbTimeSheetDepartmentDetail from './CbTimeSheetDepartmentDetail';

class CbTimeSheetApprovedList extends Component {
    /*==========================================================*/
    /* State    */
    /*==========================================================*/
    state = {
        ...
        masterGrid: {
            columnDefs:
                [
                    { headerName: '유저명', field: 'statusCdNm', minWidth: 100 },
                    { headerName: '요청자', field: 'regIdNm', minWidth: 100 },
    ...
    /*==========================================================*/
    componentDidMount() {
        this.getCbTimeSheetApprovalList();
    }

    /*==========================================================*/
    /* 승인 요청 조회   */
    /*==========================================================*/
    getCbTimeSheetApprovalList() {
        this.props.onIsLoadingTrue();
        axios.get(this.props.storeState.serviceUrl + "/CbTimeSheetService/GetCbTimeSheetApprovalList", {
            params: {
    ...
    setCacaoMap(e) {
        ...
        script.onload = async () => {
            ...
            kakao.maps.load(async () => {
                ...
                marker.setMap(map);
                var infoDiv = document.getElementById('centerAddr3');
    ...
    /* 저장    */
    /*==========================================================*/
    saveCbTimeSheetApproval(e) {
        var gParam = { ...this.state.cbTimeSheetDto };
        var id = gParam.timeId;
        var remark = gParam.remark;
        var statusCd = (e.target.id === "btnApproval") ? "10" : "99";
        var updId = this.props.storeState.userInfo.userId;
        var apprId = gParam.apprId;

        axios.post(this.props.storeState.serviceUrl + "/CbTimeSheetService/SaveCbTimeSheetApproval", {},
            {
                params: {
                    timeId: id,
                    apprId: apprId,
    ...
    // 부서 그리드 더블클릭
    deptGridDoubleClicked(selectUserInfo) {
        this.setState({
            detailPage: null
        }, () => {
            this.setState({
                activeKey: 'detail',
                detailPage: <CbTimeSheetDepartmentDetail selectUserInfo={selectUserInfo} />
            })
        })
    }
    ...
    render() {
        ...
        return (<>
            <Tabs activeKey={this.state.activeKey}
                ...
                <Tab eventKey="list" title="ApprovalList" >
                                ...
                                <Form>
                                    ...
                                    <Form.Row>
                                        <div className="col-md-12 text-right">
                                            <Button variant="primary" onClick={this.getCbTimeSheetApprovalList.bind(this)}>Search</Button>
                                        </div>
                                    </Form.Row>
                                </Form>
                            </Card.Header>
                ...
                <Tab eventKey="department" title="Department">
                    <div style={{ marginTop: 15 }}>
                        <CbTimeSheetDepartment deptGridDoubleClicked={this.deptGridDoubleClicked.bind(this)} />
                    </div>
                </Tab>
            ...
            <Modal show={this.state.modalDateShow} backdrop="static" size="lg">
                <Modal.Header className="text-right">
                    <div className="col-md-12 text-rigth">
                        {
                            this.state.cbTimeSheetDto.statusCd === '01'
                                ? <>
                                    <Button variant="success" id="btnApproval"
                                        onClick={this.saveCbTimeSheetApproval.bind(this)} >Approve</Button>{' '}
                                    <Button variant="danger" id="btnReject"
                                        onClick={this.saveCbTimeSheetApproval.bind(this)} >Reject</Button>{' '}
                                </>
                                : <></>
                        }
                        ...
                        <Form.Row>
                            <div className="col-md-12">
                                <Form.Group>
                                    ...
                                    <Form.Control type="text" size="sm"
                                        ...
                                        onChange={this.onModalChangeHandler.bind(this)}
                                    />
                                </Form.Group>
                            </div>
                            ...
                            <div className="col-md-6" style={{ marginTop: 15 }}>
                                ...
                                <div style={{ width: "100%", height: "300px", border: '1px solid #ddd', padding: 20 }}>
                                    <div id="map3" style={{ width: "100%", height: "100%" }}>
                                    </div>
                                    <Alert key={1} variant={'dark'} style={{ zIndex: 1, position: 'absolute', top: 40, left: 20 }}>
                                        <span style={{ fontWeight: 'bold' }} id="centerAddr3"></span>
                                    </Alert>
                                </div>
                            </div>
                        </Form.Row>
