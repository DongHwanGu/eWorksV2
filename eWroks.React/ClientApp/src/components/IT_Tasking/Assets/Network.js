...
class Network extends Component {
    state = {
        ...
        itAssetsGrid: {
            columnDefs:
                [
                    { headerName: 'Network Type', field: 'assetsNm', minWidth: 100 },
        ...
        itAssetsItemGrid: {
            columnDefs:
                [
                    { headerName: 'Network Nm', field: 'itemNm', minWidth: 100 },
                    { headerName: 'UseYn', field: 'useYn', minWidth: 80, cellStyle: { textAlign: 'center' } },
                ],
            rowData: [],
            defaultColDef: {
        ...
        return (<>
            ...
            <div className="row">
                <div className="col-md-6">
                    <Card>
                        <Card.Header>
                            <span style={{ fontWeight: 'bold', fontSize: 14 }}>■ Network</span>
                        </Card.Header>
                ...
                <div className="col-md-6">
                    <Card>
                        <Card.Header>
                            <span style={{ fontWeight: 'bold', fontSize: 14 }}>■ Network Item</span>
                            <Form.Row>
                                <div className="col-md-12 text-right">
                        ...
                        <Card.Body style={{ padding: 0 }}>
                            <div className="ag-theme-material"
                                style={{ height: 630, borderTop: '2px solid #695405' }}
                            >
                                <AgGridReact headerHeight={45} rowHeight={45}
            ...
            {/* Role Program Modal */}
            <Modal show={this.state.modalAssetsItem} backdrop="static" size="md">
                <Modal.Header>
                ...
                <Modal.Body>
                    <Form>
                        <Form.Row>
                            ...
                            <div className="col-md-12">
                                <Form.Group>
                                    <Form.Label className="validateText">■ Network Nm</Form.Label>
                                    <Form.Control type="text" size="sm"
                                        name="itemNm"
